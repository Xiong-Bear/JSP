...
int pageCount=0;
int curPage=1;
sql="select * from journal where category='"+cate+"';";
...
<a href = "journallist.jsp?curPage=1" >首页</a>
<a href = "journallist.jsp?curPage=<%=curPage-1%>" >上一页</a>
<a href = "journallist.jsp?curPage=<%=curPage+1%>" >下一页</a>
<a href = "journallist.jsp?curPage=<%=pageCount%>" >尾页</a>
