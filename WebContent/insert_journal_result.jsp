...
String i_journal=null;
int rs_i_journal=0;

i_journal="insert into journal values("+issn+",'"+name+"',"+issue_number+",'"+organizer+"','"+category+"');";
rs_i_journal=st.executeUpdate(i_journal);
if(rs_i_journal!=0){%>
<h1>操作成功！</h1>
