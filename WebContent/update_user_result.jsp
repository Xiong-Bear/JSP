...
String u_reader=null;
int rs_u_reader=0;

u_reader="update reader set password='"+password+"',name='"+name+"',sex='"+sex+"',department='"+department+"',major='"+major+"' where id_number="+std_number+";";
rs_u_reader=st.executeUpdate(u_reader);
if(rs_u_reader!=0){%>
<h1>操作成功！</h1>
